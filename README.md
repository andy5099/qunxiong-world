...
2.1 加入武將訓練／突破／轉生、五件神器的進化與覺醒、五章各四種難度的戰役副本，以及原創「戰魂收服」系統。擊敗 BOSS 後可收服協戰戰魂，重複收服會轉為升階用魂印。

v3 將主循環改為純狩獵玩法：普通怪累積 Boss 氣息、Boss 必定出現、低血量使用收服符、Boss 夥伴協戰與升星、五張條件解鎖地圖，以及具唯一 ID 和隨機詞條的裝備實例。主要頁籤簡化為狩獵、地圖、背包、Boss、角色、設定。
