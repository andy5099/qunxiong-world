...
export const equipmentTemplates = [
  ...
  ['w5','潮鳴散射炮','weapon','普通',3],['w6','赤道連發槍','weapon','優良',5],['w7','極光穿透炮','weapon','稀有',9],['w8','天穹重炮','weapon','史詩',14],
  ['s5','靈蜂追跡匣','secondary','普通',3],['s6','折線雷射翼','secondary','優良',5],['s7','磁暴脈衝匣','secondary','稀有',9],['s8','星雨爆裂艙','secondary','傳說',15],
  ['a5','環流護殼','armor','普通',9],['a6','曙光層甲','armor','優良',14],['a7','黑曜屏障甲','armor','稀有',20],['a8','萬象守誓甲','armor','傳說',28],
  ['e5','微光矢量引擎','engine','普通',4],['e6','霧航推進器','engine','優良',6],['e7','鏡潮折躍器','engine','稀有',10],['e8','星門巡航器','engine','史詩',15],
  ['c5','裂星微核','core','普通',7],['c6','虹膜量子核','core','優良',11],['c7','赤潮共鳴核','core','稀有',16],['c8','終焉晨星核','core','傳說',23]
