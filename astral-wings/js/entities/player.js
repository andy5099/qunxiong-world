...
export const player = (save) => {
  ...
  x: 180, y: 555, r: 6,
  hp: 100 + save.level * 5 + bonus, maxHp: 100 + save.level * 5 + bonus,
  shield: 50 + save.level * 3 + Math.floor(bonus * 0.45), maxShield: 50 + save.level * 3 + Math.floor(bonus * 0.45),
  atk: 10 + save.level * 2 + Math.floor(bonus * 0.4), energy: 0, inv: 0, fire: 0,
