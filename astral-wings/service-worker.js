const CACHE = 'astral-world-idle-v19';
const CORE = [
  './', './index.html', './styles.css', './manifest.webmanifest', './assets/game-art/manifest.json',
  ...
  './src/astral-world/art-asset-manager.js', './src/astral-world/sprite-renderer.js', './css/art-assets.css',
];
