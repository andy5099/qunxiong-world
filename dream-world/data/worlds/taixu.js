...
import { intimacyDialogue, characterConsent } from '../intimacy/dialogue.js';
export const taixu = {
  worldType:'cultivation',growthStat:'cultivation',resourceStat:'insight',gimmickSelection:{template:'taixu'},characterProfiles:characterConsent,
  ...
  sceneSuffix(state) { return state.flags['met:shen'] ? intimacyDialogue.shen[state.characters.shen.intimacyDialogueLevel || 0] : ''; },
