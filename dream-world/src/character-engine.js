...
export function createCharacterState(character) {
  return { affection:0, trust:0, intimacy:0, relationship:'陌生人', memories:[], worldMemories:[], flags:{}, mood:'觀望', status:'尚未相遇', history:[], intimacyHistory:[], unlocked:[] };
}
export function getCharacter(state, id) { return characters[id] || state.customCharacters.find(c => c.id === id); }
