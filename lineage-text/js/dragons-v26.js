...
const dragon=(id,name,title,element,hp,atk,hit,ac,armorPierce,attackInterval)=>{
 const material=`${name}之心`,item={id:`dragon-armor-${id}`,name:`${name}的力量`,slot:'盔甲',ac:-16,safe:4,weight:85,price:2400000,rarity:'傳說',protected:true,dragon:true,tier:7,sourceType:'FOUR_DRAGON',statBonuses:{str:4,dex:4,int:4,con:4,wis:4},damageReduction:6,classes:ARMOR_CLASSES,source:{mapId:id,boss:name,rarity:'四大龍專屬'}};
...
export const DRAGON_MAPS=[
 dragon(52,'安塔瑞斯','地龍・安塔瑞斯','地',180000,205,84,-58,.12,1.65),
 dragon(53,'巴拉卡斯','火龍・巴拉卡斯','火',165000,235,90,-61,.16,1.45),
 dragon(54,'法利昂','水龍・法利昂','水',195000,215,87,-63,.14,1.55),
 dragon(55,'林德拜爾','風龍・林德拜爾','風',155000,225,94,-66,.15,1.30)
];
