...
export function soulConversionReady(p,d){let a=p.activeSkillSettings||{},enabled=a.resource?.['魂體轉換']??true,mpBelow=a.soulMpBelow??30,hpAbove=a.soulHpAbove??70;return p.cls==='妖精'&&enabled&&p.learnedSkills?.includes('魂體轉換')&&p.mp/d.maxMp*100<mpBelow&&p.hp/d.maxHp*100>hpAbove;}
