import{CONSUMABLES}from'./data.js?v=53';import{PET_TYPES}from'./systems.js?v=38';
export const ARROWS={木箭:{price:1,damage:1,undead:1},銀箭:{price:3,damage:2,undead:1.5},米索莉箭:{price:8,damage:4,undead:1.25}};
