import { createCrimsonTiger, createNetherThunderBeast } from './data.js?v=v020-yellow-turban';
import { normalizeBreakthrough } from './world-boss-breakthrough.js?v=v020-yellow-turban';
