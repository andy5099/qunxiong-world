...
equal(SAVE_VERSION,13,'save v13');
...
const sw=fs.readFileSync(new URL('../service-worker.js',import.meta.url),'utf8');check(sw.includes('v017-growth'),'cache bumped');check(sw.includes('gear-tier-system.js')&&sw.includes('world-boss-breakthrough.js'),'modules cached');
