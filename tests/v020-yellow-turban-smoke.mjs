...
const migrated=normalize({...createState('舊玩家'),version:13,progress:{chapterOneComplete:true},inventory:{ironSword:4},roster:[createYellowBossMember('yellow-captain')]});equal(migrated.version,15,'v13 migrates');equal(migrated.inventory.ironSword,4,'inventory preserved');check(migrated.chapter2,'chapter state added');check(migrated.chapter2Codex['yellow-captain'],'chapter codex added');check(migrated.worldBosses.netherThunder,'nether state added');equal(migrated.party.length,5,'five party slots preserved');
