...
check(sw.includes("const BUILD_VERSION = 'v031-rematch-1'"),'single build version');
...
check(html.includes('style.css?v=v031-rematch-1')&&html.includes('src/main.js?v=v031-rematch-1'),'HTML asset versions match');
check(main.includes("buildVersion = 'v031-rematch-1'")&&main.includes("updateViaCache: 'none'"),'registration bypasses SW HTTP cache');
