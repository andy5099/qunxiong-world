...
check(sw.includes("const BUILD_VERSION = 'v026-bonds-combo-2'"),'single build version');
...
check(html.includes('style.css?v=v026-bonds-combo-2')&&html.includes('src/main.js?v=v026-bonds-combo-2'),'HTML asset versions match');
check(main.includes("buildVersion = 'v026-bonds-combo-2'")&&main.includes("updateViaCache: 'none'"),'registration bypasses SW HTTP cache');
