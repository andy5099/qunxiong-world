...
check(sw.includes("const BUILD_VERSION = 'v021-hotfix-cache-1'"),'single build version');
...
check(html.includes('style.css?v=v021-hotfix-cache-1')&&html.includes('src/main.js?v=v021-hotfix-cache-1'),'HTML asset versions match');
check(main.includes("buildVersion = 'v021-hotfix-cache-1'")&&main.includes("updateViaCache: 'none'"),'registration bypasses SW HTTP cache');
