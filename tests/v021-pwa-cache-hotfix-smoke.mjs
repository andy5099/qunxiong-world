...
check(sw.includes("const BUILD_VERSION = 'v027-divine-awakening-1'"),'single build version');
...
check(html.includes('style.css?v=v027-divine-awakening-1')&&html.includes('src/main.js?v=v027-divine-awakening-1'),'HTML asset versions match');
check(main.includes("buildVersion = 'v027-divine-awakening-1'")&&main.includes("updateViaCache: 'none'"),'registration bypasses SW HTTP cache');
