...
check(sw.includes("const BUILD_VERSION = 'v022-flipper-final-1'"),'single build version');
...
check(html.includes('style.css?v=v022-flipper-final-1')&&html.includes('src/main.js?v=v022-flipper-final-1'),'HTML asset versions match');
check(main.includes("buildVersion = 'v022-flipper-final-1'")&&main.includes("updateViaCache: 'none'"),'registration bypasses SW HTTP cache');
