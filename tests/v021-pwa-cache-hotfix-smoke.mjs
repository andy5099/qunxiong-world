...
check(sw.includes("const BUILD_VERSION = 'v026-bonds-combo-1'"),'single build version');
...
check(html.includes('style.css?v=v026-bonds-combo-1')&&html.includes('src/main.js?v=v026-bonds-combo-1'),'HTML asset versions match');
check(main.includes("buildVersion = 'v026-bonds-combo-1'")&&main.includes("updateViaCache: 'none'"),'registration bypasses SW HTTP cache');
