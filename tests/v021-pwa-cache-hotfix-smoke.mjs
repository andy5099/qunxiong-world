...
check(sw.includes("const BUILD_VERSION = 'v030-yellow-heaven-1'"),'single build version');
...
check(html.includes('style.css?v=v030-yellow-heaven-1')&&html.includes('src/main.js?v=v030-yellow-heaven-1'),'HTML asset versions match');
check(main.includes("buildVersion = 'v030-yellow-heaven-1'")&&main.includes("updateViaCache: 'none'"),'registration bypasses SW HTTP cache');
