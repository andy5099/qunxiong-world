...
check(sw.includes("const BUILD_VERSION = 'v025-world-boss-collection-1'"),'single build version');
...
check(html.includes('style.css?v=v025-world-boss-collection-1')&&html.includes('src/main.js?v=v025-world-boss-collection-1'),'HTML asset versions match');
check(main.includes("buildVersion = 'v025-world-boss-collection-1'")&&main.includes("updateViaCache: 'none'"),'registration bypasses SW HTTP cache');
