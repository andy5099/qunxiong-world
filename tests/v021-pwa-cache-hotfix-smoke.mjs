...
check(sw.includes("const BUILD_VERSION = 'v032a-art-1'"),'single build version');
...
check(html.includes('style.css?v=v032a-art-1')&&html.includes('src/main.js?v=v032a-art-1'),'HTML asset versions match');
check(main.includes("buildVersion = 'v032a-art-1'")&&main.includes("updateViaCache: 'none'"),'registration bypasses SW HTTP cache');
