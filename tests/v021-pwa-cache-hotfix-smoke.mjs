...
check(sw.includes("const BUILD_VERSION = 'v023-flipper-chain-1'"),'single build version');
...
check(html.includes('style.css?v=v023-flipper-chain-1')&&html.includes('src/main.js?v=v023-flipper-chain-1'),'HTML asset versions match');
check(main.includes("buildVersion = 'v023-flipper-chain-1'")&&main.includes("updateViaCache: 'none'"),'registration bypasses SW HTTP cache');
