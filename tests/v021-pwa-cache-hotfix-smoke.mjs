...
check(sw.includes("const BUILD_VERSION = 'v024-world-boss-capture-1'"),'single build version');
...
check(html.includes('style.css?v=v024-world-boss-capture-1')&&html.includes('src/main.js?v=v024-world-boss-capture-1'),'HTML asset versions match');
check(main.includes("buildVersion = 'v024-world-boss-capture-1'")&&main.includes("updateViaCache: 'none'"),'registration bypasses SW HTTP cache');
